									...
									<tr>
										...
										<td>
											<div class="form-button-action">
												...
												<a href="cetak_sku.php?id_request_sku=<?= $id_request_sku; ?>">
													<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-info" data-original-title="Cetak">
									...
									<tr>
										...
										<td>
											<div class="form-button-action">
												...
												<a href="cetak_skp.php?id_request_skp=<?= $id_request_skp; ?>">
													<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-info" data-original-title="Cetak">
														<i class="fa fa-print"></i>
													</button>
												</a>
									...
									<tr>
										...
										<td>
											<div class="form-button-action">
												...
												<a href="cetak_skd.php?id_request_skd=<?= $id_request_skd; ?>">
													<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-info" data-original-title="Cetak">
														<i class="fa fa-print"></i>
													</button>
												</a>
