...
<head>
    ...
    <title>Pelayanan Surat Keterangan Online Kelurahan Sumur Kidang</title>
    <!-- core CSS -->
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="main/img/OIP.jpg" width="150" height="54" alt="logo"></a>
                </div>
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>PELAYANAN</span> SURAT KETERANGAN <br> KELURAHAN SUMURKIDANG</h2>
    ...
    <section id="contact">
        <div>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.3333082778126!2d109.36912711431887!3d-7.087305771443884!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6fe8a3f19326f1%3A0x970e7d49a1eca400!2sKantor%20Kepala%20Desa%20Sumur%20Kidang!5e0!3m2!1sid!2sid!4v1676143609684!5m2!1sid!2sid" width="100%" height="650px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </section>
    <!--/#bottom-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y');?> KANTOR KELURAHAN SUMURKIDANG KECAMATAN BANTARBOLANG KABUPATEN PEMALANG
                </div>
                <div class="col-sm-6">
